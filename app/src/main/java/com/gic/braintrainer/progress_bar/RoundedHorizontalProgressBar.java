package com.gic.braintrainer.progress_bar;
...
public class RoundedHorizontalProgressBar extends ProgressBar {
    ...
    private void setUpStyleable(Context context , AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.RoundedHorizontalProgressBar);

        mBackgroundColor = typedArray.getColor(R.styleable.RoundedHorizontalProgressBar_backgroundColor, Color.GRAY);
        mProgressColor = typedArray.getColor(R.styleable.RoundedHorizontalProgressBar_progressColor, Color.BLUE);
        mIsRounded = typedArray.getBoolean(R.styleable.RoundedHorizontalProgressBar_isRounded, true);
